...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 w-[250px] h-[100vh] bg-black bg-opacity-50 text-white z-50 transition-transform duration-500 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                {/* <div className='flex justify-between items-center p-4'>
                    <FontAwesomeIcon icon={faX} onClick={toggleSidebar} className='cursor-pointer' />
                </div> */}
                <ul className='mt-14'>
                    <li className=' my-[10px] mx-[20px] text-lg cursor-pointer p-3'>
